                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {
                        product.map((pro) => (
                            ...
                            <div key={pro.id} className="bg-white rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.02] transition-all">
                                <div className="w-full aspect-w-16 aspect-h-8 lg:h-80">
                                    <img src={pro.img} alt="Product 1"
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="mt-4 flex items-center flex-wrap gap-2">
                                        <h4 className="text-lg font-bold text-gray-800">{pro.Price}</h4>
