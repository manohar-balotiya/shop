                        ...
                        <ul
...

                            {
                                navigations.map((nav) => (
                                    ...
                                    <li key={nav.id} className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                                        <a href={nav.path}
                                            className='hover:text-[#007bff] text-black block font-semibold text-[15px]'>{nav.title}</a>
                                    </li>
                                ))
                            }
